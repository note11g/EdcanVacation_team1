...
import com.edcan.shareformproject.databinding.ActivityGoogleLoginBinding;
...
//        setContentView(R.layout.activity_google_login);
        ...
        binding.btnGloginLogin.setOnClickListener(view -> {
            signIn();
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(GoogleLoginActivity.this, "Successed", Toast.LENGTH_SHORT).show();
    ...
    private void updateUI(FirebaseUser user) { //update ui code here
        if (user != null) {
            Intent intent = new Intent(this, getPermissonActivity.class);
            startActivity(intent);
            finish();
        }
    }
